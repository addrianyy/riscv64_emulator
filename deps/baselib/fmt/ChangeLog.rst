...
* Captured automatic ``std::ostream`` insertion operator (``operator<<``)
...
* Captured implicit conversions of scoped enums to integers that was
...
* Captured the use of UDL template extension on GCC 9
...
* Captured templated user-defined literals when compiled under nvcc
...
* Captured unsafe implicit conversion to ``std::string``
