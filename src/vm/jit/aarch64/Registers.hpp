...
class RegisterAllocation {
 public:
  ...
  constexpr static auto trampoline_block = A64R::X7;

  constexpr static auto a_reg = A64R::X7;
  constexpr static auto b_reg = A64R::X8;

  constexpr static A64R cache[]{
    A64R::X9,  A64R::X10, A64R::X11, A64R::X12, A64R::X13,
    A64R::X14, A64R::X15, A64R::X16, A64R::X17,
